...
## Setup 1: Underdamped (Low Viscosity)
![Setup 1 Histogram](./Images/Setup%201.png)
...
## Setup 2: Balanced Damping (Medium Viscosity)
![Setup 2 Histogram](./Images/Setup%202.png)
...
## Setup 3: Overdamped (High Viscosity)
![Setup 3 Histogram](./Images/Setup%203.png)
